...
from opencd.models.utils.rewrite import cast_data
    ...
    for i in range(len(inputs)):
        ...
        if data_samples is not None:
            ...
            if isinstance(data_sample, dict):
                ...
                # 更新元信息
                if 'metainfo' not in data_sample:
...
class FoundationInputSegDataPreProcessor(nn.Module):
    ...
    def forward(self, data: dict, training: bool = False) -> Dict[str, Any]:
        ...
        data = cast_data(data, device=self.device, non_blocking=self._non_blocking)
        inputs = data['inputs']
            ...
            if self.test_cfg:
                ...
                for data_sample, pad_info in zip(data_samples, padded_samples):
                    ...
                    if isinstance(data_sample, dict):
                        if 'metainfo' not in data_sample:
                            data_sample['metainfo'] = {}
                        data_sample['metainfo'].update(pad_info)
                    else:
